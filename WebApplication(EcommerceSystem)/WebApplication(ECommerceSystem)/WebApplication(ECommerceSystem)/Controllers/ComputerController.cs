...
namespace WebApplication_ECommerceSystem_.Controllers
{
    public class ComputerController : Controller
    {
        ...
        private const string ControllerName = "Computer";

        IComputerBuss buss;
        ICommonBuss ddl;
        public ComputerController(IComputerBuss _buss, ICommonBuss _ddl)
        {
            buss = _buss;
            ddl = _ddl;
        }
        ...
        public ActionResult Index()
        {
            ...
            ViewData["BreadCrumb"] = ApplicationGrid.GetAddBreadCum("Computer|Computer Registration|Registered Computer List", ControllerName, ViewId);
            return View();
        }
        public string GetGridDetails(GridDetails param)
        {
            ...
            HtmlGrid<ComputerCommon> companyGrid = new HtmlGrid<ComputerCommon>();
        ...
        public ActionResult Manage()
        {
            ...
            if (data.Count == 0)
            {
                ComputerCommon model = new ComputerCommon();



                model.BreadCum = ApplicationGrid.GetBreadCum("Computer |Computer Regestration |Manage ");
                return View(model);
            }
            ...
            data[0].BreadCum = ApplicationGrid.GetBreadCum("Computer |Computer Regestration |Manage ");
            return View(data[0]);
            //return View();
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Manage(ComputerCommon model)
        {
            if (model != null)
            {
        ...
        public ActionResult ShowComputer()
        {
            //var list = new List<ProductSearchCommon>();

            var list = buss.ShowComputer();
